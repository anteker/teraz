    ...
    <section className="py-20 px-4 bg-white-primary">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* IndigoMC Shop Card */}
          <Card className="bg-black-primary border-4 border-indigo-primary rounded-none p-6 hover:transform hover:scale-105 transition-transform">
          ...
          {/* Survival Shop Card */}
          <Card className="bg-black-primary border-4 border-white-primary rounded-none p-6 hover:transform hover:scale-105 transition-transform">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-white-primary mb-4">
